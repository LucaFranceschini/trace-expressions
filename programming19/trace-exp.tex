...
We chose trace expressions as a specification formalism for different reasons: they are quite expressive \cite{ancona2016comparing}, they support parameters \cite{AnconaFM17} and they can be directly implemented in Prolog (see \cite{TowardsIoT17} for more information on the implementation of a monitoring system based on trace expressions).
