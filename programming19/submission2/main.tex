...
Preliminary benchmarks with the popular http module and the Express framework show that the tool is able to support runtime verification of real Node.js code.
\end{abstract}
