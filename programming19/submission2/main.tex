...
In this work we show how trace expressions can be employed in the context of runtime verification for Node.js Web applications to specify the expected behavior,
and we present the implementation of a tool allowing automatic monitoring of the correct use
of the features offered by the widespread Node.js library \lstinline{http}.
...
Benchmarks with the popular http module and the Express framework show that the tool is able to support runtime verification of real Node.js code.
\end{abstract}
