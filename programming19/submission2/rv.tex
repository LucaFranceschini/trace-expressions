...
Another critical aspect of runtime verification systems is the implementation of the monitor itself, especially since it is desirable to automatically generate its code from the high-level formal specification. %%, thus making their adoption and application easier.
...
in \Cref{sec:examples} show that this is an essential feature to verify properties of real Node.js applications.
